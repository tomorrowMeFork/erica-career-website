# bcc487ab-9260-4d94-939a-16e7374aa11a implementation handoff
...
## Entry points
- `erica-safety-dashboard-2.html`
- `erica-safety-dashboard.html`
- `index.html`
- `layer1.html`
- `layer2.html`
- `layer3.html`
...
- `DESIGN.md`
- `mpte99z6-00-test-execution-log.md`
- `mpte99z7-01-overview.md`
- `mpte99z7-02-layer1-input-safety.md`
- `mpte99z7-03-layer2-source-safety.md`
- `mpte99z7-04-layer3-evidence-policy.md`
- `mpte99z7-05-layer4-prompt-engineering.md`
- `mpte99z7-06-layer5-output-validation.md`
- `mpte99z7-07-audit-log.md`
- `mpte99z7-08-safety-filtering-e2e.md`
- `mpte99z8-README.md`
