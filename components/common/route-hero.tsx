...
export function RouteHero({ eyebrow, title, description, actions, titleId, className, children, ...props }: RouteHeroProps) {
  ...
  return (
    <section className={cn("w-full", className)} aria-labelledby={headingId} {...props}>
      <Card className="erica-surface-strong relative overflow-hidden border-border/80 text-card-foreground ring-1 ring-primary/10 after:pointer-events-none after:absolute after:-right-16 after:-top-20 after:size-56 after:rounded-full after:bg-secondary after:opacity-55 after:blur-2xl">
