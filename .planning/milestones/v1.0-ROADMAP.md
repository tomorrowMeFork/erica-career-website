...
**Wave 6** *(gap closure after Phase 3 UAT)*
- [x] 03-07-PLAN.md — Close the live smoke gap with dotenv-loaded, timeout-configurable, secret-safe provider smoke support.
...
Archived after v1.0 shipment. For the active roadmap, see `.planning/ROADMAP.md`.
